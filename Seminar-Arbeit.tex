...
With this as motivation, we present three solutions for dynamic reconfiguration - an approach which aims to optimize resource usage and provide the security dictated by the current situation.\par
